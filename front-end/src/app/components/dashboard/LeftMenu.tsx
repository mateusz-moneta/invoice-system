...
export default function LeftMenu() {
    ...
    const mobileMenu = (show: boolean) => {
        ...
        if (show) {
            menu.className = 'fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0';
    ...
    return (
        <>
            <button aria-controls='default-sidebar'
                    type='button'
                    className={'inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-400 rounded-lg sm:hidden focus:outline-none focus:ring-2 hover:bg-gray-700 focus:ring-gray-600'}
